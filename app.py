...
# DEFINIÇÃO DAS ABAS (Onde estava o erro: isso precisa existir antes do 'with tab3')
...
with tab3:
    ...
    df_reincidencia = df_filtered.groupby('ID_Ref').agg(
        ...
        Motivos_Lista=('Motivo', lambda x: list(set(x))),
    ...
    if not df_criticos.empty:
        ...
        st.dataframe(
            ...
            column_config={
                ...
                "Episodios_Reais": st.column_config.ProgressColumn("Episódios", format="%d", min_value=0, max_value=df_criticos['Episodios_Reais'].max()),
